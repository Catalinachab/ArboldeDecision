...
Aclaración: Como había varios nodos finales con un 0 %, temimos que el modelo estuviera sobreajustado. Por ello, decidimos modificar el dominio de exploración de los hiperparámetros. Algunas métricas mejoraron y otras empeoraron; sin embargo, nos guiamos por el valor de AUC. Este resultó ser inferior al actual, por lo que optamos por descartarlo y continuar con el árbol actual.

Inferimos que el modelo podría estar generando un camino demasiado específico a partir de los datos de entrenamiento, pero eso no implica que, al momento de evaluar con los datos de prueba, estos lleguen necesariamente a esas hojas finales.
